...
export default function LoginPage() {
	...
	return (
		<div className='min-h-screen bg-gradient-to-b from-[#050910] via-[#0a1020] to-[#0b1224] text-slate-100 flex items-center justify-center px-4'>
			{/* Background Effects */}
					...
					<form onSubmit={handleSubmit} className='space-y-6'>
						...
						<div className='relative'>
							...
							<div className='relative flex justify-center text-xs uppercase'>
								<span className='bg-[#0a1020] px-2 text-slate-500'>
									Or continue with
								</span>
							</div>
						</div>
